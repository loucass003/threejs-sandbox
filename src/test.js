...
Response.prototype = {
	...
	,collide_and_slide: function(packet,gravity) {
		...
		packet.depth = 0;
		final_position = this.collide_with_world(packet,_$Test_Vec3_$Impl_$.copy(e_position),_$Test_Vec3_$Impl_$.copy(e_velocity),slide_threshold);
		var b2 = packet.e_radius;
		...
		packet.depth = 0;
		final_position = this.collide_with_world(packet,_$Test_Vec3_$Impl_$.copy(final_position),_$Test_Vec3_$Impl_$.copy(e_velocity),slide_threshold);
